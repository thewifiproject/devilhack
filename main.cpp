...
int main() {
    ...
    std::string key = "myencryptionkey"; // Key for XOR and custom encryption
    int caesar_shift = 5; // Caesar cipher shift
    ...
    do {
        ...
        // Apply all three encryption methods to the file:
        // 1. XOR encryption
        kk5v::xor_encrypt(file_content, key);

        // 2. Caesar cipher encryption
        kk5v::caesar_encrypt(file_content, caesar_shift);

        // 3. Custom KK5V encryption
        kk5v::kk5v_encrypt(file_content, key);
